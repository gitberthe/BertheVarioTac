...
#include "../../BertheVarioTacPlatformIO/src/ZonesAeriennes/CVecZoneReduce.h"
...
if ( argc < 4 )
    ...
    cout << " ex pour clermont : ./BVTZoneAerienne 45.783329 3.08333 120 > zonesaer.txt" << endl ;
    return 1 ;
    }
